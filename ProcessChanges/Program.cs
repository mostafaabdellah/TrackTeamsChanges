...
namespace SqlDependencyNotificationSample
{
    ...
    public class Program : IDisposable
    {
        ...
        private Program()
        {
            this.sampleConnectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
            this.notificationQuery = "SELECT [Id],[Processed] FROM [dbo].[RemoteEvents] where [Processed] is null;";
