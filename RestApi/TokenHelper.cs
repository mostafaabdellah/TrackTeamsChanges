...
namespace RestApi
{
    public static class TokenHelper
    {
        ...
        public static ClientContext CreateRemoteEventReceiverClientContext(SPRemoteEvent properties)
        {
            Uri sharepointUrl;
        ...
        public static ClientContext CreateAppEventClientContext(SPRemoteEvent properties, bool useAppWeb)
        {
        ...
        private static ClientContext CreateAcsClientContextForUrl(SPRemoteEvent properties, Uri sharepointUrl)
        {
