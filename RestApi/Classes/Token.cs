    ...
    class RetrieveSPListData
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                string stGetTenantDetailsUrl = "https://gandxb1.sharepoint.com/_vti_bin/client.svc/ Jump ";
                string stGetAccessTokenUrl = "https://accounts.accesscontrol.windows.net/ Jump {0}/tokens/OAuth/2 ";

                string tenantID = string.Empty;
                string resourceID = string.Empty;
                string accessToken = string.Empty;
                string stClientID = "Client_ID"; // pass the client id which is created in Step 1, https://< Jump ;sitename>.sharepoint.com/_layouts/15/appregnew.aspx
                ...
                string stSiteDetailsUrl = "https://gandxb1.sharepoint.com/_api/web? Jump $select=Title";
